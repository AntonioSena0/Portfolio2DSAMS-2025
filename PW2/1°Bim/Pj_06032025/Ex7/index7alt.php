...
<body class="body1">
    ...
    <section>
        ...
        <br>
        <input type="number" max="10" min="0" name="nt1" class="num" required>
        <br>
        <strong>
        ...
        <br>
        <input type="number" max="10" min="0" name="nt2" class="num" required>      
        <br>
        <strong>
        ...
        <br>
        <input type="number" max="10" min="0" name="nt3" class="num" required>
        <br>
        <strong>
        ...
        <br>
        <input type="number" max="10" min="0" name="nt4" class="num" required>     
        <br>
