...
-- A descriçãoo queijo já existia, então fiz o contrário como solicitado pela professora	
...
update Envio set Regiao = '' where Regiao is null
select * from Envio
...
pontos_fidelidade float not null
);

insert into clientes
values('Ana Souza', 'São Paulo', 120);
insert into clientes
values('Bruno Lima', 'Rio de Janeiro', 80);
insert into clientes
values('Carla Dias', 'Salvador', 150);
select * from clientes

update clientes set pontos_fidelidade = pontos_fidelidade + 50
select * from clientes

update clientes set pontos_fidelidade = pontos_fidelidade + 30 where nome like 'Carla Dias'
select * from clientes

update clientes set pontos_fidelidade = pontos_fidelidade/2 where cidade like 'Rio de Janeiro'
select * from clientes