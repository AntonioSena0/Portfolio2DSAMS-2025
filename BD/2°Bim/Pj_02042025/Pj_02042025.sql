...
Insert Into Produtos values('Teclado', 100, 10)
Insert Into Produtos values('Mouse', 150, 10)
Insert Into Produtos values('Gabinete', 500, 10)
Insert Into Produtos values('Fonte', 549.99, 10)
Insert Into Produtos values('Processador', 1249.99, 10)
Insert Into Produtos values('Placa de Vídeo AMD', 2700, 10)
Insert Into Produtos values('Placa de Vídeo NVIDIA', 3000, 10)
Insert Into Produtos values('SSD', 250.99, 10)
Insert Into Produtos values('HD', 239.99, 10)
Insert Into Produtos values('Placa Mãe', 400, 10)

select * from Produtos

delete from Produtos Where Preco < 200
select * from Produtos

delete from Produtos Where  Nome_Prod in ('SSD', 'HD')
select * from Produtos

delete from Produtos Where Quantidade = 10
select * from Produtos
--Também Poderia ser escrito (Delete from Produtos)